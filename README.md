...
- Products in the Accessories category significantly contributed more to sales than other categories.
- Customer preference for payment methods is balanced, with nearly equal distribution among Credit Card, Bank Transfer and PayPal.
  ...
  Link to interactive report: [Click here](https://app.powerbi.com/view?r=eyJrIjoiM2EyM2ZhYmQtY2U4Zi00ZWQ4LThhNzMtOGZmNzVkMzJjZTI3IiwidCI6IjZjNzQ3Mzg1LTUyNTktNDcwMS05MTkzLTc5ZTkxNWNlYjA3ZSJ9)

## Data Cleaning and Transformation
- Removed duplicate entries from the Invoice No column.
- Identified and handled approximately 3,000 null values from the Warehouse Location column by using fill down.
...
- Accessories consistently outsell all other product categories. In 2025, sales reached $2.67M, exceeding second placed Electronics by $1.24M.
- Stationery and Electronics pulled in revenue consistently at 2nd and 3rd  place.

### Monthly revenue by Sales Channel
- In-store and online sales trends vary across years.
- In 2021 and 2023, in-store sales dipped in April and in subsequent years, in-store sales did reasonably well in April.
...
- Promote products in Apparel, Kitchen Utensil and Furniture categories, as they consistently underperform compared to others. Increased promotions and visibility will be beneficial.
